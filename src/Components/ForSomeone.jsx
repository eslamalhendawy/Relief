      ...
      {stage === 2 && (
        <div className="border border-[#BBD0FF] md:w-[80%] lg:w-[70%] md:mx-auto p-3 md:p-6 rounded-xl">
          ...
          <div className="flex items-center justify-between lg:w-[80%] xl:w-[70%] lg:mx-auto">
            ...
            <button onClick={handleStage2} className="capitalize bg-accent hover:bg-red-700 duration-200 text-white py-1 px-12 rounded-xl text-xs md:text-lg font-[500] border border-accent text-center">
              Next
            </button>
          </div>
        </div>
      ...
      {stage === 3 && (
        <div className="border border-[#BBD0FF] md:w-[80%] lg:w-[70%] md:mx-auto p-3 md:p-6 rounded-xl py-24 md:py-[140px]">
          ...
          <div className="flex items-center justify-between lg:w-[80%] xl:w-[70%] lg:mx-auto">
            ...
            <button onClick={() => setStage(4)} className="capitalize bg-accent hover:bg-red-700 duration-200 text-white py-1 px-12 rounded-xl text-xs md:text-lg font-[500] border border-accent text-center">
              Next
            </button>
          </div>
        </div>
