  ...
  return (
    <section className="container mx-auto px-4 py-16">
      ...
      <div className="flex flex-col items-center justify-center border-2 border-[#BBD0FF] rounded-xl py-12  lg:w-[70%] mx-auto px-2">
        ...
        <Link to="/choose-care-receiver" className="capitalize border mb-4 border-[#8D99AE] hover:border-[#BBD0FF] text-[#8D99AE] hover:text-[#003049] duration-200 py-1 w-[70%] rounded-xl text-xs md:text-lg font-[500] text-center">I want to arrange care for me or someone else</Link>
