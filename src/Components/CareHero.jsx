  ...
  return (
    <section className="container mx-auto px-4 py-12 flex gap-6 xl:gap-12 flex-col md:flex-row items-center">
      <div className="md:basis-1/2">
        <h1 className="text-navyColor font-[600] text-4xl md:text-6xl xl:text-[90px] text-center md:text-left mb-4 capitalize">
          {headerNavy} <span className="text-accent">{headerRed}</span>
        </h1>
        ...
        {role === "carer" ? null : (
          <div className="flex flex-col lg:flex-row items-center gap-6">
            ...
            <Link to="/speak-to-expert" className="capitalize border border-[#8D99AE] hover:border-navyColor text-[#8D99AE] hover:text-navyColor duration-200 py-2 px-6 rounded-xl text-lg font-[500]">
              speak to an expert
            </Link>
          </div>
        )}
