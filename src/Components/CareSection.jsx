  ...
  return (
    <section className="container mx-auto py-12 px-4">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 xl:gap-12 mb-8 lg:mb-24">
        ...
        <div className="">
          <h3 className="text-navyColor font-semibold text-2xl lg:text-4xl text-center lg:text-left mb-4 2xl:mb-12">What is the importance of Elderly care?</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 xl:gap-12">
        <div className="">
          <h3 className="text-navyColor font-semibold text-2xl lg:text-4xl text-center lg:text-left mb-4 2xl:mb-12">Who would benefit from elderly care service</h3>
